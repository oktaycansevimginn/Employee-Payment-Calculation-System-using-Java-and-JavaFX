...
public class Main extends Application {
	...
	private File myEmployeeFile = new File("‪C:\\Users\\Oktay Can\\Desktop\\employee.txt"); 

	private int index = 0; 

	private Employee[] employeeArray = new Employee[100]; 
	...
	public void start(Stage primaryStage) {
		...
		try {
			...
			borderpane.setStyle("-fx-background-color: #FF0000;"); 
